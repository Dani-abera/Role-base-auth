...
import 'package:role_base_auth/Pages/signin_screen.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              Image.asset(
                  "images/vecteezy_biometric-fingerprint-authentication-3d-illustration_14219600.png"), // Display login screen image
